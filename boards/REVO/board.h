...
/*
 * Setup for CC3D Revo with STM32F405RGT6 board.
 */
 ...
 */
#define BOARD_REVO
#define BOARD_NAME                  "CC3D Revo with STM32F405RGT6"
 ...
 * IO pins assignments.
 */
#define GPIOA_PWM6                  0U
#define GPIOA_PWM5                  1U
#define GPIOA_PWM4                  2U
#define GPIOA_PWM3                  3U
...
#define GPIOA_Modem_NSEL            15U

#define GPIOB_PWM1                  0U
#define GPIOB_PWM2                  1U
...
#define GPIOB_PWM12                 14U
#define GPIOB_PWM7                  15U

#define GPIOC_SBUS_Invert           0U
#define GPIOC_Current               1U
#define GPIOC_Voltage               2U
#define GPIOC_PIN3                  3U
#define GPIOC_MPU6000_INT           4U
#define GPIOC_VBUS_SENS             5U
#define GPIOC_PWM8                  6U
#define GPIOC_PIN7                  7U
#define GPIOC_PWM10                 8U
#define GPIOC_PWM9                  9U
 ...
 */
#define LINE_PWM6                   PAL_LINE(GPIOA, 0U)
#define LINE_PWM5                   PAL_LINE(GPIOA, 1U)
#define LINE_PWM4                   PAL_LINE(GPIOA, 2U)
#define LINE_PWM3                   PAL_LINE(GPIOA, 3U)
...
#define LINE_Modem_NSEL             PAL_LINE(GPIOA, 15U)
#define LINE_PWM1                   PAL_LINE(GPIOB, 0U)
#define LINE_PWM2                   PAL_LINE(GPIOB, 1U)
...
#define LINE_PWM12                  PAL_LINE(GPIOB, 14U)
#define LINE_PWM7                   PAL_LINE(GPIOB, 15U)
#define LINE_SBUS_Invert            PAL_LINE(GPIOC, 0U)
#define LINE_Current                PAL_LINE(GPIOC, 1U)
#define LINE_Voltage                PAL_LINE(GPIOC, 2U)
#define LINE_MPU6000_INT            PAL_LINE(GPIOC, 4U)
#define LINE_VBUS_SENS              PAL_LINE(GPIOC, 5U)
#define LINE_PWM8                   PAL_LINE(GPIOC, 6U)
#define LINE_PWM10                  PAL_LINE(GPIOC, 8U)
#define LINE_PWM9                   PAL_LINE(GPIOC, 9U)
 ...
 * GPIOA setup:
 *
 * PA0  - PWM6                      (alternate 2).
 * PA1  - PWM5                      (alternate 2).
 * PA2  - PWM4                      (alternate 1).
 * PA3  - PWM3                      (output pushpull maximum).
 ...
 * PA15 - Modem_NSEL                (output pushpull maximum).
 */
#define VAL_GPIOA_MODER             (PIN_MODE_ALTERNATE(GPIOA_PWM6) |       \
                                     PIN_MODE_ALTERNATE(GPIOA_PWM5) |       \
                                     PIN_MODE_ALTERNATE(GPIOA_PWM4) |       \
                                     PIN_MODE_OUTPUT(GPIOA_PWM3) |          \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOA_Modem_NSEL))
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_PWM6) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PWM5) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_Modem_NSEL))
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_PWM6) |          \
                                     PIN_OSPEED_HIGH(GPIOA_PWM5) |          \
                                     PIN_OSPEED_HIGH(GPIOA_PWM4) |          \
                                     PIN_OSPEED_HIGH(GPIOA_PWM3) |          \
                                     PIN_OSPEED_HIGH(GPIOA_SPI1_NSS) |      \
                                     PIN_OSPEED_MEDIUM(GPIOA_SPI1_SCK) |    \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOA_Modem_NSEL))
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_PWM6) |       \
                                     PIN_PUPDR_FLOATING(GPIOA_PWM5) |       \
                                     PIN_PUPDR_FLOATING(GPIOA_PWM4) |       \
                                     PIN_PUPDR_FLOATING(GPIOA_PWM3) |       \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOA_Modem_NSEL))
#define VAL_GPIOA_ODR               (PIN_ODR_LOW(GPIOA_PWM6) |              \
                                     PIN_ODR_LOW(GPIOA_PWM5) |              \
                                     PIN_ODR_LOW(GPIOA_PWM4) |              \
                                     ...
                                     PIN_ODR_HIGH(GPIOA_Modem_NSEL))
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_PWM6, 2U) |          \
                                     PIN_AFIO_AF(GPIOA_PWM5, 2U) |          \
                                     PIN_AFIO_AF(GPIOA_PWM4, 1U) |          \
                                     PIN_AFIO_AF(GPIOA_PWM3, 3U) |          \
...
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_PIN8, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOA_Modem_NSEL, 0U))

/*
 * GPIOB setup:
 *
 * PB0  - PWM1                      (alternate 2).
 * PB1  - PWM2                      (alternate 2).
 ...
 * PB14 - PWM12                     (alternate 9).
 * PB15 - PWM7                      (alternate 9).
 */
#define VAL_GPIOB_MODER             (PIN_MODE_ALTERNATE(GPIOB_PWM1) |       \
                                     PIN_MODE_ALTERNATE(GPIOB_PWM2) |       \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOB_PWM12) |      \
                                     PIN_MODE_ALTERNATE(GPIOB_PWM7))
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_PWM1) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PWM2) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_PWM12) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PWM7))
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_PWM1) |          \
                                     PIN_OSPEED_HIGH(GPIOB_PWM2) |          \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOB_PWM12) |         \
                                     PIN_OSPEED_HIGH(GPIOB_PWM7))
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_FLOATING(GPIOB_PWM1) |       \
                                     PIN_PUPDR_FLOATING(GPIOB_PWM2) |       \
                                     PIN_PUPDR_FLOATING(GPIOB_PIN2) |       \
                                     PIN_PUPDR_FLOATING(GPIOB_Flash_CS) |   \
                                     PIN_PUPDR_FLOATING(GPIOB_LED_WARN) |   \
                                     PIN_PUPDR_FLOATING(GPIOB_LED_STAT) |   \
                                     PIN_PUPDR_FLOATING(GPIOB_PIN6) |       \
                                     PIN_PUPDR_FLOATING(GPIOB_Mag_DRDY) |   \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOB_PWM12) |      \
                                     PIN_PUPDR_FLOATING(GPIOB_PWM7))
#define VAL_GPIOB_ODR               (PIN_ODR_LOW(GPIOB_PWM1) |              \
                                     PIN_ODR_LOW(GPIOB_PWM2) |              \
                                     PIN_ODR_HIGH(GPIOB_PIN2) |             \
                                     PIN_ODR_HIGH(GPIOB_Flash_CS) |         \
                                     PIN_ODR_HIGH(GPIOB_LED_WARN) |         \
                                     PIN_ODR_HIGH(GPIOB_LED_STAT) |         \
                                     ...
                                     PIN_ODR_HIGH(GPIOB_PWM12) |            \
                                     PIN_ODR_HIGH(GPIOB_PWM7))
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_PWM1, 2U) |          \
                                     PIN_AFIO_AF(GPIOB_PWM2, 2U) |          \
...
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_I2C1_SCL, 4U) |      \
                                     ...
                                     PIN_AFIO_AF(GPIOB_PWM12, 9U) |         \
                                     PIN_AFIO_AF(GPIOB_PWM7, 9U))

/*
 * GPIOC setup:
 *
 * PC0  - SBUS_Invert               (output pushpull maximum).
 * PC1  - Current                   (input floating).
 * PC2  - Voltage                   (input floating).
 * PC3  - PIN3                      (input floating).
 * PC4  - MPU6000_INT               (input floating).
 * PC5  - VBUS_SENS                 (input floating).
 * PC6  - PWM8                      (alternate 3).
 * PC7  - PIN7                      (input floating).
 * PC8  - PWM10                     (alternate 3).
 * PC9  - PWM9                      (alternate 3).
 ...
 */
#define VAL_GPIOC_MODER             (PIN_MODE_OUTPUT(GPIOC_SBUS_Invert) |   \
                                     PIN_MODE_INPUT(GPIOC_Current) |        \
                                     PIN_MODE_INPUT(GPIOC_Voltage) |        \
                                     PIN_MODE_INPUT(GPIOC_PIN3) |           \
                                     PIN_MODE_INPUT(GPIOC_MPU6000_INT) |    \
                                     PIN_MODE_INPUT(GPIOC_VBUS_SENS) |      \
                                     PIN_MODE_ALTERNATE(GPIOC_PWM8) |       \
                                     PIN_MODE_INPUT(GPIOC_PIN7) |           \
                                     PIN_MODE_ALTERNATE(GPIOC_PWM10) |      \
                                     PIN_MODE_ALTERNATE(GPIOC_PWM9) |       \
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_SBUS_Invert) |\
                                     PIN_OTYPE_PUSHPULL(GPIOC_Current) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOC_Voltage) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN3) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOC_MPU6000_INT) |\
                                     PIN_OTYPE_PUSHPULL(GPIOC_VBUS_SENS) |  \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PWM8) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN7) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PWM10) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PWM9) |       \
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_HIGH(GPIOC_SBUS_Invert) |   \
                                     PIN_OSPEED_HIGH(GPIOC_Current) |       \
                                     PIN_OSPEED_HIGH(GPIOC_Voltage) |       \
                                     PIN_OSPEED_HIGH(GPIOC_PIN3) |          \
                                     PIN_OSPEED_HIGH(GPIOC_MPU6000_INT) |   \
                                     PIN_OSPEED_HIGH(GPIOC_VBUS_SENS) |     \
                                     PIN_OSPEED_HIGH(GPIOC_PWM8) |          \
                                     PIN_OSPEED_HIGH(GPIOC_PIN7) |          \
                                     PIN_OSPEED_HIGH(GPIOC_PWM10) |         \
                                     PIN_OSPEED_HIGH(GPIOC_PWM9) |          \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_FLOATING(GPIOC_SBUS_Invert) |\
                                     PIN_PUPDR_FLOATING(GPIOC_Current) |    \
                                     PIN_PUPDR_FLOATING(GPIOC_Voltage) |    \
                                     PIN_PUPDR_FLOATING(GPIOC_PIN3) |       \
                                     PIN_PUPDR_FLOATING(GPIOC_MPU6000_INT) |\
                                     PIN_PUPDR_FLOATING(GPIOC_VBUS_SENS) |  \
                                     PIN_PUPDR_FLOATING(GPIOC_PWM8) |       \
                                     PIN_PUPDR_FLOATING(GPIOC_PIN7) |       \
                                     PIN_PUPDR_FLOATING(GPIOC_PWM10) |      \
                                     PIN_PUPDR_FLOATING(GPIOC_PWM9) |       \
...
#define VAL_GPIOC_ODR               (PIN_ODR_LOW(GPIOC_SBUS_Invert) |       \
                                     PIN_ODR_HIGH(GPIOC_Current) |          \
                                     PIN_ODR_HIGH(GPIOC_Voltage) |          \
                                     PIN_ODR_HIGH(GPIOC_PIN3) |             \
                                     PIN_ODR_HIGH(GPIOC_MPU6000_INT) |      \
                                     PIN_ODR_HIGH(GPIOC_VBUS_SENS) |        \
                                     PIN_ODR_LOW(GPIOC_PWM8) |              \
                                     PIN_ODR_HIGH(GPIOC_PIN7) |             \
                                     PIN_ODR_LOW(GPIOC_PWM10) |             \
                                     PIN_ODR_LOW(GPIOC_PWM9) |              \
...
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_SBUS_Invert, 0U) |   \
                                     PIN_AFIO_AF(GPIOC_Current, 0U) |       \
                                     PIN_AFIO_AF(GPIOC_Voltage, 0U) |       \
                                     PIN_AFIO_AF(GPIOC_PIN3, 0U) |          \
                                     PIN_AFIO_AF(GPIOC_MPU6000_INT, 0U) |   \
                                     PIN_AFIO_AF(GPIOC_VBUS_SENS, 0U) |     \
                                     PIN_AFIO_AF(GPIOC_PWM8, 3U) |          \
                                     PIN_AFIO_AF(GPIOC_PIN7, 0U))
#define VAL_GPIOC_AFRH              (PIN_AFIO_AF(GPIOC_PWM10, 3U) |         \
                                     PIN_AFIO_AF(GPIOC_PWM9, 3U) |          \
...
#define VAL_GPIOD_PUPDR             (PIN_PUPDR_FLOATING(GPIOD_OSC_IN) |     \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOD_Modem_IRQ) |  \
